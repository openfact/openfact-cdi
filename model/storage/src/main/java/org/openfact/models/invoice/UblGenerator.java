...
public class UblGenerator {
    private static final ObjectFactorySunat FACTORIA = new ObjectFactorySunat();
    private final static GregorianCalendar c = new GregorianCalendar();
    private static JAXBContext context, contextI;
    ...
    private AdditionalInformation informacionAdicional;
    ...
    public UblGenerator() throws JAXBException {
    ...
    private void getContextMarshall() throws JAXBException {
        if (context == null) {
            context = JAXBContext.newInstance(AdditionalInformation.class);
        }
        if (contextI == null) {
            contextI = JAXBContext.newInstance(InvoiceType.class);
        }
        if (marshallerElement == null) {
            marshallerElement = context.createMarshaller();
        }
        if (marshallerInvoice == null) {
            marshallerInvoice = contextI.createMarshaller();
    ...
    public void validar() throws JAXBException, SAXException {
        ...
        File file = new File("D:\\Factura\\UBLPE-UblGenerator-1.0.xsd");
    ...
    public void generar() throws JAXBException {
        JAXBElement<AdditionalInformation> jeAits = FACTORIA.createAdditionalInformation(informacionAdicional);
        getContextMarshall();
    ...
    public void addFacturaExtensionesExtensionContenidoDeExtensionInformacionAdicionalPropiedadAdicional(CodigoElementosAdicionalesComprobante cod, String valor) {
        ...
        AdditionalProperty propiedadAdicional = FACTORIA.createAdditionalPropertyType();
    ...
    public void setSignatureSignatoryPartyPartyNameName(String nombre) {
        ...
        bas.setValue(nombre);
        partyNameType.setName(bas.getValue());/*observado*/
    }
    ...
    public void setTaxTotalTaxSubtotalTaxCategoryTaxScheme(CodigoTipoTributo codigo) {
        ...
        taxSchemeType.setName(nameTypeCommBas.getValue());
    ...
    public void addInvoiceLine(DetalleFactura det) {
        ...
        leat.setCurrencyID(det.getLineExtensionAmountCurrencyCode().getCodigo());
        ...
        amountType.setCurrencyID(det.getPriceAmountCurrencyCode().getCodigo());
        ...
        tat.setCurrencyID(det.getTaxTotalTaxAmountCodigo().getCodigo());
        ...
        taxAmountSub.setCurrencyID(det.getTaxTotalTaxSubtotalTaxAmountCodigo().getCodigo());
        ...
        taxSchemeType2.setName(nameTypeCommBas.getValue());
        ...
        amountTypeDet.setCurrencyID(det.getPricePriceAmountCodigo().getCodigo());
