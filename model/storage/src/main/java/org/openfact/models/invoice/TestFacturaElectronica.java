 ...
 */
public class TestFacturaElectronica {
    public TestFacturaElectronica() {
    }
    ...
    public void marshallFacturaElectronica() {
        try {
            ...
            ublGenerator.setTaxTotalTaxAmount(new BigDecimal("62675.85"), CurrencyCodeContentTypeFact.PERU);
            ublGenerator.setTaxTotalTaxSubtotalTaxAmount(new BigDecimal("62675.85"), CurrencyCodeContentTypeFact.PERU);
            ublGenerator.setTaxTotalTaxSubtotalTaxCategoryTaxScheme(CodigoTipoTributo.IGV);
            ublGenerator.setLegalMonetaryTotalPayableAmount(new BigDecimal("423225.00"), CurrencyCodeContentTypeFact.PERU);

            DetalleFactura det1 = new DetalleFactura();
            det1.setId("1");
            det1.setInvoicedQuantity("NIU", new BigDecimal("2000"));
            det1.setLineExtensionAmount(CurrencyCodeContentTypeFact.PERU, new BigDecimal("149491.53"));
            det1.setPricingReferenceAlternativeConditionPricePriceAmount(CurrencyCodeContentTypeFact.PERU, new BigDecimal("98.00"));
            det1.setPricingReferenceAlternativeConditionPricePriceTypeCode(CodigoTipoPrecioVentaUnit.PRECIO_UNITARIO); //cambiar
            det1.setTaxTotalTaxAmount(new BigDecimal("26908.47"), CurrencyCodeContentTypeFact.PERU);
            det1.setTaxTotalTaxSubtotalTaxAmount(new BigDecimal("26908.47"), CurrencyCodeContentTypeFact.PERU);
            ...
            det1.setPricePriceAmount(new BigDecimal("83.05"), CurrencyCodeContentTypeFact.PERU);
            ...
            Logger.getLogger(TestFacturaElectronica.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception e) {
            Logger.getLogger(TestFacturaElectronica.class.getName()).log(Level.SEVERE, null, e);
        }
    }
